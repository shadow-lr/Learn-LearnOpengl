...
int main()
{
	...
	std::string objectVertexShaderPath = "shaders/basic_lighting/shaderBaseLighting.vert";
	std::string objectFragShaderPath = "shaders/basic_lighting/shaderBaseLighting.frag";
	std::string lightFragShaderPath = "shaders/basic_lighting/shaderBaseLighting.frag";
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightingShader.Use();
		lightingShader.SetColor("objectColor", { 1.0f, 0.5f, 0.31f });
		lightingShader.SetColor("lightColor", { 1.0f, 1.0f, 1.0f });
		lightingShader.SetPos("lightPos", { lightPos.s, lightPos.y, lightPos.z });

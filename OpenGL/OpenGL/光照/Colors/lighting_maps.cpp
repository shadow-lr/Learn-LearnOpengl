...
int main()
{
	...
	std::string objectVertexShaderPath = "shaders/materials/shaderLightingMaps.vert";
	std::string objectFragShaderPath = "shaders/materials/shaderLightingMaps.frag";
	std::string lightFragShaderPath = "shaders/materials/shaderLightingMaps.frag";
